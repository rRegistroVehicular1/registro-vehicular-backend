  ...
  private buildValues({
    ...
    return [
      [
        ...
        observacionGeneralVisuales,
        "",
        luces1?.nombre, luces1?.funcionaSi ? "sí" : "no" : "N/A",
        luces2?.nombre, luces2?.funcionaSi ? "sí" : "no" : "N/A",
        luces3?.nombre, luces3?.funcionaSi ? "sí" : "no" : "N/A",
        luces4?.nombre, luces4?.funcionaSi ? "sí" : "no" : "N/A",
        luces5?.nombre, luces5?.funcionaSi ? "sí" : "no" : "N/A",
        luces6?.nombre, luces6?.funcionaSi ? "sí" : "no" : "N/A",
        luces7?.nombre, luces7?.funcionaSi ? "sí" : "no" : "N/A",
        luces8?.nombre, luces8?.funcionaSi ? "sí" : "no" : "N/A",
        "",
