  ...
  async getRowFromSheet(rowNumber: number) {
    ...
    try {
      ...
      const requests = [
        ...
        { range: 'Hoja1!G75', values: [[revisionGolpes === null ? "N/A" : revisionGolpes ? "sí" : "no"]] },
        { range: 'Hoja1!G76', values: [[revisionLlave === null ? "N/A" : revisionLlave ? "sí" : "no"]] },
        { range: 'Hoja1!G77', values: [[revisionBasura === null ? "N/A" : revisionBasura ? "sí" : "no"]] },
        { range: 'Hoja1!G78', values: [[revisionLuces === null ? "N/A" : revisionLuces ? "sí" : "no"]] },
        { range: 'Hoja1!G79', values: [[maletinPrimerosAuxilios === null ? "N/A" : maletinPrimerosAuxilios ? "sí" : "no"]] },
        { range: 'Hoja1!G80', values: [[revisionConos === null ? "N/A" : revisionConos ? "sí" : "no"]] },
        { range: 'Hoja1!G81', values: [[revisionTriangulos === null ? "N/A" : revisionTriangulos ? "sí" : "no"]] },
        { range: 'Hoja1!G82', values: [[revisionExtintor === null ? "N/A" : revisionExtintor ? "sí" : "no"]] },
        { range: 'Hoja1!G83', values: [[revisionLlantaRepuesto === null ? "N/A" : revisionLlantaRepuesto ? "sí" : "no"]] },
        { range: 'Hoja1!G84', values: [[revisionGato === null ? "N/A" : revisionGato ? "sí" : "no"]] },
        { range: 'Hoja1!G85', values: [[revisionCarretilla === null ? "N/A" : revisionCarretilla ? "sí" : "no"]] },
        { range: 'Hoja1!G86', values: [[revisionCuñas === null ? "N/A" : revisionCuñas ? "sí" : "no"]] },
