  ...
  async getRowFromSheet(rowNumber: number) {
    ...
    try {
      ...
      const requests = [
        ...
        { range: 'Hoja1!G75', values: [[revisionGolpes ? "N/A" : revisionGolpes ? "sí" : "no"]] },
        { range: 'Hoja1!G76', values: [[revisionLlave ? "N/A" : revisionLlave ? "sí" : "no"]] },
        { range: 'Hoja1!G77', values: [[revisionBasura ? "N/A" : revisionBasura ? "sí" : "no"]] },
        { range: 'Hoja1!G78', values: [[revisionLuces ? "N/A" : revisionLuces ? "sí" : "no"]] },
        { range: 'Hoja1!G79', values: [[maletinPrimerosAuxilios ? "N/A" : maletinPrimerosAuxilios ? "sí" : "no"]] },
        { range: 'Hoja1!G80', values: [[revisionConos ? "N/A" : revisionConos ? "sí" : "no"]] },
        { range: 'Hoja1!G81', values: [[revisionTriangulos ? "N/A" : revisionTriangulos ? "sí" : "no"]] },
        { range: 'Hoja1!G82', values: [[revisionExtintor ? "N/A" : revisionExtintor ? "sí" : "no"]] },
        { range: 'Hoja1!G83', values: [[revisionLlantaRepuesto ? "N/A" : revisionLlantaRepuesto ? "sí" : "no"]] },
        { range: 'Hoja1!G84', values: [[revisionGato ? "N/A" : revisionGato ? "sí" : "no"]] },
        { range: 'Hoja1!G85', values: [[revisionCarretilla ? "N/A" : revisionCarretilla ? "sí" : "no"]] },
        { range: 'Hoja1!G86', values: [[revisionCuñas ? "N/A" : revisionCuñas ? "sí" : "no"]] },
